...
namespace bmerketo.Migrations
{
    ...
    [Migration("20230520164427_MadeCategoryNameRequired")]
    partial class MadeCategoryNameRequired
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("bmerketo.Models.Entities.ImageEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("bmerketo.Models.Entities.ProductReviewEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("bmerketo.Models.Entities.ProfileEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("bmerketo.Models.Identities.CustomIdentityUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("bmerketo.Models.Identities.CustomIdentityUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("bmerketo.Models.Entities.ProductImageEntity", b =>
                {
                    ...
                    b.HasOne("bmerketo.Models.Entities.ImageEntity", "Image")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("bmerketo.Models.Entities.ProfileEntity", b =>
                {
                    b.HasOne("bmerketo.Models.Identities.CustomIdentityUser", "User")
                        .WithMany()
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
